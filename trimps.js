...
const itemCost = {
    ...
    shield:         [0, 40,  2301, 85833, 2183000, Math.max(), 1400*million, Math.max(), Math.max(), Math.max(), Math.max(), Math.max(), Math.max(), Math.max(), Math.max(), Math.max(), Math.max(), Math.max(), Math.max(), Math.max()],
    dagger:         [0, 40,  2301, 85833, 2183000, Number.MAX_VALUE, 1400*million, 'test', Math.max(), Math.max(), Math.max(), Math.max(), Math.max(), Math.max(), Math.max(), Math.max(), Math.max(), Math.max(), Math.max(), Math.max()],
    boots:          [0, 55,  3164, 118000, 3000000, Math.max(), 1930*million, Math.max(), Math.max(), Math.max(), Math.max(), Math.max(), Math.max(), Math.max(), Math.max(), Math.max(), Math.max(), Math.max(), Math.max(), Math.max()],
